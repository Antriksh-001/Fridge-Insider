  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection:'row',marginTop:-10}}>
        ...
        <Text style={{marginLeft:10,marginTop:-17,fontSize:40 ,color:'rgba(0,0,0,0.50)',fontFamily:'SF-Pro-Rounded-Bold'}}>7°</Text>
      </View>
              ...
              return (
                ...
                >
                 <TouchableOpacity style={{
                  ...
                  <View style={{position:'absolute',top:-25,backgroundColor:Colors.bg, shadowColor:'#213a7c',elevation:8,padding:40,borderRadius:100}}>
